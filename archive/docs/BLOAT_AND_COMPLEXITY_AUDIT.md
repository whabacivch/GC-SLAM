...
**Keep:** FRAME_AND_QUATERNION_CONVENTIONS, GC_SLAM, IMU_BELIEF_MAP_AND_FUSION, OPERATOR_CONTRACTS, PIPELINE_*, POST_INTEGRATION_CHECKLIST_AUDIT, SIGMA_G_AND_FUSION_EXPLAINED, BAG_TOPICS_AND_USAGE, TESTING, EVALUATION, POINTCLOUD2_LAYOUTS, etc.
